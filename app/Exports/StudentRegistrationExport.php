...
class StudentRegistrationExport implements FromCollection,WithHeadings,ShouldAutoSize
{
    ...
    public function collection()
    {
        ...
        'after_college_plan','school_name','accommodation','paid','comment','gender')->get();
    }
}
