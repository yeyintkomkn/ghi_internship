...
class StudentAcomodationExport implements FromCollection,WithHeadings,ShouldAutoSize
{
    ...
    public function collection()
    {
       return DB::table('student_registrations')->select('name','year_level','email','phone',
        ...
        'after_college_plan','school_name','accommodation','paid','comment','gender')->where('accommodation','yes')->get();
    }
}
